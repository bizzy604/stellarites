...
export default function Home() {
    return (
        <div className="bg-background-light dark:bg-background-dark text-text-light dark:text-text-dark font-sans transition-colors duration-300">
                    ...
                    <div className="mt-16 relative mx-auto max-w-5xl rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 overflow-hidden bg-white dark:bg-surface-dark transform rotate-1 hover:rotate-0 transition-transform duration-500">
                        ...
                        <div className="pt-10 pb-6 px-6 bg-surface-light dark:bg-surface-dark">
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div className="bg-primary/5 dark:bg-primary/10 rounded-xl p-6 border border-primary/10 flex flex-col items-center text-center justify-center">
                                    <div className="w-16 h-16 rounded-full bg-white dark:bg-gray-800 flex items-center justify-center mb-4 shadow-sm text-primary">
                                        <span className="material-icons-outlined text-3xl">bolt</span>
                                    </div>
                                    <h3 className="font-semibold text-lg mb-1 dark:text-white">Instant Transfer</h3>
                                    <p className="text-sm text-gray-500 dark:text-gray-400">Processing on Stellar</p>
            ...
            <section className="bg-surface-light dark:bg-surface-dark py-12 border-y border-gray-100 dark:border-gray-800">
